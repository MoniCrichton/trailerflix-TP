...
/*!50001 VIEW `vista_catalogo` AS select `catalogo`.`id` AS `id`,`catalogo`.`poster` AS `poster`,`catalogo`.`titulo` AS `titulo`,`catalogo`.`categoria` AS `categoria`,`catalogo`.`genero` AS `genero`,`catalogo`.`resumen` AS `resumen`,`catalogo`.`temporadas` AS `temporadas`,`catalogo`.`reparto` AS `reparto`,`catalogo`.`trailer` AS `trailer` from `catalogo` */;
...
-- Dump completed on 2023-09-30 14:47:08
